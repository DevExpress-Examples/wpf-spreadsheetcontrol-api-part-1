...
'#Region "#PrintWorkbook"
            ...
            Using link As LegacyPrintableComponentLink = New LegacyPrintableComponentLink(workbook)
                link.CreateDocument()
                link.ShowPrintPreviewDialog(Windows.Application.Current.MainWindow)
            End Using
